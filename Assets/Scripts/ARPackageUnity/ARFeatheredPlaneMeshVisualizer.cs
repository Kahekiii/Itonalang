...
public class ARFeatheredPlaneMeshVisualizer : MonoBehaviour
{
    ...
    // Subscribe to the boundaryChanged event when the component is enabled
    void OnEnable()
    {
        m_Plane.boundaryChanged += ARPlane_boundaryUpdated;
    }

    // Unsubscribe from the boundaryChanged event when the component is disabled
    void OnDisable()
    {
        m_Plane.boundaryChanged -= ARPlane_boundaryUpdated;
    }

    // Event handler for boundaryChanged
